						...
						<div class="graph">
							<div class="tables">
								...
								<table class="table table-bordered">
										...
										<div class="form-body">
											...
											<form>
												<div class="form-group">
													<label for="exampleInputEmail1">Enter the taluka</label> <input
														type="text" name="subadmintaluka" class="form-control"
														id="exampleInputEmail1" placeholder="Taluka">
												</div>
												<div class="form-group">
									...
									<%
										String taluka = request.getParameter("subadmintaluka");
										...
										try {
											...
											PreparedStatement ps = con.prepareStatement("select * from csregdetail where cstaluka=?");
