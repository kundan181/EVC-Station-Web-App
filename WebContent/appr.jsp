				...
				<div class="outter-wp">
				 ...
				 -->
							...
							<tr>
								...
								<td><a href="approve.jsp?id=<%=rs.getInt("csid")%>">Approve</a></td>
							</tr>
							<%
								}
								} catch (Exception e) {
								...
								<div class="menu">
									<ul id="menu">
										...
										<li id="menu-academico"><a href="#"><i
												class="fa fa-smile-o"></i><span>Approve CS</span><span
										...
										<li id="menu-academico"><a href="#"><i
												class="fa fa-smile-o"></i> <span>Delete CS</span> <span
												class="fa fa-angle-double-right" style="float: right"></span></a>
											<ul id="menu-academico-sub">
												<li id="menu-academico-avaliacoes"><a
													href="csdelete.html">Delete</a></li>
												<!-- <li id="menu-academico-boletim" ><a href="validation.html">Validation Forms</a></li>
												<li id="menu-academico-boletim" ><a href="table.html">Tables</a></li>
												<li id="menu-academico-boletim" ><a href="buttons.html">Buttons</a></li>-->
											</ul></li>
