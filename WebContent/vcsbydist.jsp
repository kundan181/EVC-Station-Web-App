							...
							<div class="tables">
								...
								<table class="table table-bordered">
									...
									<div class="graph-form">
										<div class="form-body">
											<form action="vcsbydist.jsp">
												<div class="form-group">
													<label for="exampleInputEmail1">Enter the district</label>
													<input type="text" name="userdist" class="form-control"
														id="exampleInputEmail1" placeholder="District">
												</div>
												<div class="form-group">
									...
									<%
										String dist = request.getParameter("userdist");
